...
namespace Meetins.Communication.Hubs
{
    ...
    {
        public List<MessengerUser> Users { get; } = new();
        ...
        public void ConnectUser(string userName, string connectionId)
        {
            ...
            var user = new MessengerUser(userName);
        ...
        /// <param name="connectionId"></param>
        /// <returns></returns>
        private MessengerUser? GetConnectedUserById(string connectionId) =>
            Users
        ...
        /// <returns></returns>
        private MessengerUser? GetConnectedUserByName(string userName) =>
            Users
